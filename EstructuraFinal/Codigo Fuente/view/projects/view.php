    ...
    <main class="project-content">
                       ...
                       <?php if (strcmp($task->getStatus(), "ToDo") == 0): ?>
                        <div class="task">
                            ...
                            <div>
                              ...
                              <a href="index.php?controller=tasks&amp;action=edit&amp;id=<?= $project->getId()?>&amp;task_id=<?= $task->getId()?>">
                                <button class="btn"><?= i18n("Editar") ?></button>
                            </a>
                             <a href="index.php?controller=tasks&amp;action=edit&amp;id=<?= $project->getId()?>&amp;task_id=<?= $task->getId()?>">
                                <button class="btn"><?= i18n("Editar") ?></button>
                            </a>
                            <form action="index.php?controller=tasks&amp;action=delete&amp;id=<?= $project->getId()?>&amp;task_id=<?= $task->getId()?>">
        ...
        <div class="task-actions">
          ...
          <a href="index.php?controller=projects&amp;action=edit&amp;id=<?= $project->getId()?>">
            <button class="btn action-btn" id="editProjBtn" style="margin-top:12px"><?= i18n("Editar Proyecto") ?></button>
          </a>
                       
            <form action="index.php?controller=projects&amp;action=delete&amp;id=<?= $project->getId()?>">
                 <button class="btn danger action-btn" id="deleteProjBtn" type="submit"><?= i18n("Eliminar Proyecto") ?></button>
            </form>
        </div>
    </main>
</body>
