class MainComponent extends Fronty.RouterComponent { //Va a ser el enrutador en el SPA (herencia)
  constructor() {
    ...
    this.userService = new UserService(); //Servicio para loguearse

    super.setRouterConfig({ //para una determinada variable, crea un componente con acceso a los modelos necesarios
      posts: {
      ...
      defaultRoute: 'posts' //lo que se visualiza por defecto
    });
  ...
  _createLanguageComponent() { // # es para identificar ids en fronty
